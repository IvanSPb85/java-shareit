...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> findItemForRent(long userId, String text, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "text", text,
                "from", from,
                "size", size
    ...
    public ResponseEntity<Object> createComment(long userId, long itemId, InComingCommentDto inComingCommentDto) {
